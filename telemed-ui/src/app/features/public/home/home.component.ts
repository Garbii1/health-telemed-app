...
export class HomeComponent implements OnInit, OnDestroy { // Implement OnInit, OnDestroy
  ...
  backgroundImages: string[] = [
    '/telemed-ui/src/assets/hero-background.jpeg',       // Your original image
    '/telemed-ui/src/assets/hero-background-2.jpeg',     // Add second image path
    '/telemed-ui/src/assets/hero-background-3.jpeg',      // Add third image path
    '/telemed-ui/src/assets/hero-background-4.jpg',
    '/telemed-ui/src/assets/hero-background-5.jpg',
    '/telemed-ui/src/assets/hero-background-6.jpeg',
    '/telemed-ui/src/assets/hero-background-7.jpeg',
    '/telemed-ui/src/assets/hero-background-8.jpeg',
    '/telemed-ui/src/assets/hero-background-9.jpeg'
  ];
